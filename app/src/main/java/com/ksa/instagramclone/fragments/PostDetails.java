 ...
 * Use the {@link PostDetails#newInstance} factory method to
...
public class PostDetails extends Fragment {
    ...
    public static PostDetails newInstance(String param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            postId = mParam1;
            //Log.v("PostsDetail","postId "+postId);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View postDetailsView = inflater.inflate(R.layout.fragment_post_details, container, false);

        postList = postDetailsView.findViewById(R.id.posts_recycleriew);
        ...
        FirebaseDatabase.getInstance().getReference().child("Posts").child(postId).
                addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //Log.v("PostsDetail"," "+snapshot.getValue(PostModel.class).toString());
